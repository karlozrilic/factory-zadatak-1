    ...
    <div class="center-articles">
      ...
      <aside>
        <div class="aside-articles">
          <div class="aside-articles-links">
            <ul>
        ...
        <div class="aside-tv">
          ...
          <a class="aside-tv-link" href="/single">
            ...
            <div class="aside-tv-text">
              <div class="aside-tv-date">August 26, 2013</div>
              <div class="aside-tv-article-title">NASA releases portrait of a planet waving at Saturn</div>
            </div>
          </a>
        </div>
        ...
        <div class="aside-facebook">
            <img src="../assets/svg/asideFacebook.svg" />
        </div>
      </aside>
    </div>
    <div class="banner">
